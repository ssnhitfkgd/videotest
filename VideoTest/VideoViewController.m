...
- (void)videoPlay{
    ...
    if ([fileManager fileExistsAtPath:[cachePath stringByAppendingPathComponent:[NSString stringWithFormat:@"vedio.mp4"]]]) {
        ...
        ASIHTTPRequest *request=[[ASIHTTPRequest alloc] initWithURL:[NSURL URLWithString:@"http://v.youku.com/player/getRealM3U8/vid/XNjkyNzI0OTY4/type/mp4/video.m3u8"]];
...
- (void)playVideo{
    MPMoviePlayerViewController *playerViewController =[[MPMoviePlayerViewController alloc]initWithContentURL:[NSURL URLWithString:@"http://v.youku.com/player/getRealM3U8/vid/XNjkyNzI0OTY4/type/mp4/video.m3u8"]];//http://127.0.0.1:12345/vedio.mp4"]];
    [self presentMoviePlayerViewControllerAnimated:playerViewController];
}
